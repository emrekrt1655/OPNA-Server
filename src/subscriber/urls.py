...
from .views import SubscriberListView, SubscriberCategoryListView, SubscriberDeleteApiView, SubscriberCreateApiView, SubscriberUpdateApiView, SubscriberDetailView
