...
class LanguageSerializer(serializers.ModelSerializer):
    class Meta:
        model = Language
        fields = ['detail_url', 'headtitle', 'slug', 'level', 'image', 'excerpt', 'published', 'day', 'month', 'year', 'date_created', 'text', 'text_content',
...
class LanguageDetailSerializer(serializers.ModelSerializer):
    ...
    update_url = serializers.HyperlinkedIdentityField(
        view_name='update-language',
        lookup_field='slug'
    )
    delete_url = serializers.HyperlinkedIdentityField(
        view_name='delete-language',
        lookup_field='slug'
    )
